        ...
        <>
            <div style={{background:"teal",zIndex:"9"}}>
                ...
                <div className=" action-btn">
                    <button className="flex-btn jma-pdg-8" onClick={()=>{viewCart('#c-modal-popup')}}>
                    ...
                    <button className="jma-pdg-8 jma-right" onClick={()=>{viewCart('#x-modal-popup')}}>
                    ...
                    <button className="jma-pdg-8 jma-right" onClick={()=>{viewCart('#z-modal-popup')}}>
